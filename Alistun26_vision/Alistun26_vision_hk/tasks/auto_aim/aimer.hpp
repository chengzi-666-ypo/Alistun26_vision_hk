...
public:
  ...
  double get_yaw_offset() const { return yaw_offset_ * 57.3; } // 返回度数
  double get_pitch_offset() const { return pitch_offset_ * 57.3; } // 返回度数
  void set_yaw_offset(double yaw_deg) { yaw_offset_ = yaw_deg / 57.3; }
  void set_pitch_offset(double pitch_deg) { pitch_offset_ = pitch_deg / 57.3; }
