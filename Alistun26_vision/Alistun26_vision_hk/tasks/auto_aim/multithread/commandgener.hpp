...
public:
  ...
  void push(
    ...
    double bullet_speed, const Eigen::Vector3d & gimbal_pos, bool allow_shoot = true);

  io::Command get_latest_command();
  auto_aim::AimPoint get_debug_aim_point();
